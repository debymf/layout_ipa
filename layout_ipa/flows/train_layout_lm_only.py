...
from layout_ipa.tasks.preprocessing.rico_sca import (
    ...
    PrepareRicoLayoutLMOnly,
)
from layout_ipa.tasks.models import SelectionLayoutLMTrainer
...
prepare_rico_layout_task = PrepareRicoLayoutLMOnly()
transformer_trainer_task = SelectionLayoutLMTrainer()
